...
import com.r2jp2.motor.MyMotor.MotorRequest;
...
public class MyColorFinder implements Runnable {
	...
	private Map<Integer, Integer> colorToSound = new HashMap<Integer, Integer>();
	
	
	public MyColorFinder(MyMotor motorThread, MyColorSensor colorSensorThread) {
	...
	{
		if(currentColor == Color.YELLOW || currentColor == Color.RED || currentColor == Color.BLUE){
